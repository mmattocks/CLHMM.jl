...
function modstep(hmm::HMM{Univariate,Float64}, observations::Matrix{Int64}, obs_lengths::Vector{Int64})
    ...
    #RECURRENCE
    βoi_T,Tijm_T,Eoγim_T=modsweep!(hmm,a,N,Γ,βoi_T,βoi_t,Tijm_T,Tijm_t,Eoγim_T,Eoγim_t,observations,mask,obs_lengths)
...
function modsweep!(hmm::HMM{Univariate,Float64}, a::Matrix{Float64},N::Int64,Γ::Int64,βoi_T::Matrix{Float64},βoi_t::Matrix{Float64},Tijm_T::Array{Float64},Tijm_t::Array{Float64},Eoγim_T::Array{Float64},Eoγim_t::Array{Float64}, observations::Matrix{Int64}, mask::BitMatrix, obs_lengths::Vector{Int64})
